...
const MyComponent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <div className="w-[100%] h-[100%] pr-4 pt-[60px] flex flex-col justify-center items-center">
        <div className="mb-4 w-[80%] h-[20%]">
          <input
            type="text"
            value={inputValue}
      ...
      <div className="w-[100%] h-[100%]  border-gray-300 p-10">
        <ul className="mb-4">
