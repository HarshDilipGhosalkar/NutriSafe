  ...
  return (
    <>
      <div className="mt-[20px] flex flex-col justify-center items-center">
        ...
        <div className="flex py-[15px] w-[100%] border-[1px] justify-around">
        ...
        <div className="rounded-[20px] my-[10px] w-[95%] h-[220px] bg-white mb-4 flex justify-evenly items-center border-[1px] border-gray-300 bottom-1 ">
          <div className="w-[45%] h-[100%]  flex flex-col justify-center items-center">
            ...
            <button
              class="bg-red-400 mt-7 h-8 text-white rounded-[25px] px-3 transition duration-300 hover:bg-blue-600"
          ...
          <div className="w-[50%] h-[100%] bg-slate-50">
            <div className="w-[183px] h-[183px] mx-auto mt-4">
              <div className=" pt-0 rounded-[10px] w-full h-full my-auto">
